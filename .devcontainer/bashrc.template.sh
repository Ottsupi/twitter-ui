...
# Using color prompt
if [[ ${EUID} == 0 ]] ; then
    PS1='\[\033[38;2;0;135;175m\]\h \[\033[38;2;83;85;85m\]\w \[\033[38;2;105;121;16m\]\$ \[\033[0m\]'
else
    PS1='\[\033[38;2;0;135;175m\]\u@\h \[\033[38;2;83;85;85m\]\w \[\033[38;2;105;121;16m\]\$ \[\033[0m\]'
fi
